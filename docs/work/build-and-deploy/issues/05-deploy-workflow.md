...
- [ ] Release command runs migrations first (issue 03); a failure aborts cleanly
...
- [ ] Deployed commit SHA surfaced in the startup log (`server-restructure` issue 05) so the running
